		...
		<main>
			<?php
				...
				if(isset($_POST["transfer"]))
				{
					...
					$sql0 = "SELECT * FROM customers WHERE name='$fname'";
					...
					while($row = mysqli_fetch_assoc($result0))
					{
						if($amt <= $row['c_bal'])
						{
							...
							$sql1 = "UPDATE customers SET c_bal = c_bal + $amt WHERE name='$tname'";
							$result1 = mysqli_query($conn, $sql1);
		

							$sql2 = "UPDATE customers SET c_bal = c_bal - $amt WHERE name='$fname'";
